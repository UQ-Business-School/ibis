// JavaScript Document
 const iconsData = {
      ...
      "bsan": [
        { category: "mbusan", name:"ethical-debate" },
        { category: "mbusan", name:"social-activity" },
        { category: "mbusan", name:"interactive-book" },
        { category: "mbusan", name:"coding-bootcamp" },
        { category: "mbusan", name:"module-reflection" },
        { category: "mbusan", name:"link" },
        { category: "mbusan", name:"live" },
        { category: "mbusan", name:"module" },
        { category: "mbusan", name:"reading" },
        { category: "mbusan", name:"activity" },
        { category: "mbusan", name:"new-tab" }
      ]
